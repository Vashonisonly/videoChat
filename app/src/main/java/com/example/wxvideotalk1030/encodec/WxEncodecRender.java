...
public class WxEncodecRender implements WXEGLSurfaceView.WxGLRender {
    private static final String TAG = "WxEncodecRender";
    ...
    public WxEncodecRender(Context context, int textureId){
        Log.d(TAG,"WxEncodecRender construct");
        this.context = context;
        this.textureId = textureId;

        bitmap = WxShaderUtil.createTextImage("视频直播和推流：王鑫",50,"#ff0000","#00000000",0);
